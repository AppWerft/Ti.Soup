...
Local<FunctionTemplate> DocumentProxy::getProxyTemplate(v8::Isolate* isolate)
{
	...
	t->Set(titanium::Proxy::inheritSymbol.Get(isolate), FunctionTemplate::New(isolate, titanium::Proxy::inherit<DocumentProxy>));
...
Local<FunctionTemplate> DocumentProxy::getProxyTemplate(v8::Local<v8::Context> context)
{
